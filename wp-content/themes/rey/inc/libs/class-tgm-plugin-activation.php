...
if ( ! class_exists( 'Rey_TGM_Plugin_Activation' ) ) {
	...
	class Rey_TGM_Plugin_Activation extends TGM_Plugin_Activation {
		 ...
		 * Returns the singleton instance of the class.
		 *
		 * @return \Rey_TGM_Plugin_Activation Rey_TGM_Plugin_Activation object.
		 */
		public static function get_instance() {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof self ) ) {
				self::$instance = new self();
	...
	if ( ! function_exists( 'load_rey_tgm_plugin_activation' ) ) {
		function load_rey_tgm_plugin_activation() {
			$GLOBALS['tgmpa'] = Rey_TGM_Plugin_Activation::get_instance();
		}
	}

	if ( did_action( 'plugins_loaded' ) ) {
		load_rey_tgm_plugin_activation();
	} else {
		add_action( 'plugins_loaded', 'load_rey_tgm_plugin_activation' );
	}
}
