<?php $wooFeedDropDown = new Woo_Feed_Dropdown_Pro(); ?>
<div class="wrap">
	<h2><?php _e( 'Add Option', 'woo-feed' ); ?></h2>
	...
	<form action="" name="feed" method="post" autocomplete="off">
		...
		<table class="widefat" style="max-width: 440px;margin: 20px auto;padding: 20px;">
			...
			<tr>
				<td style="width: 130px;max-width: 130px;"><label for="wpfp_option"><b><?php _e( 'Option Name', 'woo-feed' ); ?> <span class="requiredIn">*</span></b></label></td>
				<td>
			...
			<tr>
				<td colspan="2" style="text-align: center">
					<button type="submit" class="button button-primary"><?php _e( 'Add Option', 'woo-feed' ); ?></button>
				</td>
			</tr>
			<tr><td colspan="2"></td></tr>
			</tbody>
