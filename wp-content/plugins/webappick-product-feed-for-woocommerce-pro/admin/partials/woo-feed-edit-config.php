...
<table class="table tree widefat fixed mtable" style="width: 100%" id="table-1">
	<tr>
		<td colspan="3">
		<textarea name="feed_config_custom2" id="editor" style="width: 100%;font-weight: bold;" rows="20">
        <?php
	...
	<tr>
		...
		<td>
			<b><input type="text" class="regular-text" onclick="this.select();" readonly id="custom2_attribute_value"></b>
		</td>
	</tr>
</table>
<?php } else { ?>
