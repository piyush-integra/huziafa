...
?>
<div class="wrap">
	<h2><?php esc_html_e( 'Attribute Mapping List', 'woo-feed' ); ?><a href="<?php echo esc_url( admin_url( 'admin.php?page=webappick-manage-attribute-mapping&action=add-mapping' ) ); ?>" class="page-title-action"><?php esc_html_e( 'Add New Mapping', 'woo-feed' ); ?></a></h2>
