...
class Woo_Feed_Merchant {
	...
	protected function load_merchant_infos() {
		$this->merchant_infos = include WOO_FEED_PRO_PATH . 'includes/feeds/merchant_infos.php';
	}
	...
	protected function load_merchant_templates() {
		$this->templates = include WOO_FEED_PRO_PATH . 'includes/feeds/merchant_templates.php';
