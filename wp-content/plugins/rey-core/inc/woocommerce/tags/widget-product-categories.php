 ...
 * @extends WC_Widget
 */
class Rey_WC_Widget_Product_Categories extends WC_Widget {
	...
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce rey-widget-pCat';
		$this->widget_description = __( 'A list or dropdown of product categories.', 'rey-core' );
		$this->widget_id          = 'rey_woocommerce_product_categories';
		$this->widget_name        = __( 'Ajax Product Categories (Rey)', 'rey-core' );
		$this->settings           = array(
			'title'              => array(
				'type'  => 'text',
				'std'   => __( 'Product categories', 'rey-core' ),
			...
			'orderby'            => array(
				...
				'options' => array(
					'order' => __( 'Category order', 'rey-core' ),
			...
			'dropdown'           => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Show as dropdown', 'rey-core' ),
			),
			'count'              => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Show product counts', 'rey-core' ),
			),
			'hierarchical'       => array(
				'type'  => 'checkbox',
				'std'   => 1,
			...
			'hide_empty'         => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Hide empty categories', 'rey-core' ),
			),
			'max_depth'          => array(
				'type'  => 'text',
				'std'   => '',
				...
				if ( jQuery().selectWoo ) {
					var wc_product_cat_select = function() {
						jQuery( '.dropdown_product_cat' ).selectWoo( {
							placeholder: '" . esc_js( __( 'Select a category', 'rey-core' ) ) . "',
							minimumResultsForSearch: 5,
							width: '100%',
							allowClear: true,
							language: {
								noResults: function() {
									return '" . esc_js( _x( 'No matches found', 'enhanced select', 'rey-core' ) ) . "';
								}
							}
						} );
					};
