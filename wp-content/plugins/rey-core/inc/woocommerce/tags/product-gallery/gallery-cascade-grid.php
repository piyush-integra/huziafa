...
if( !class_exists('ReyCore_WooCommerce_ProductGallery_CascadeGrid') ):
/**
 * This will initialize Rey's product page galleries
 */
class ReyCore_WooCommerce_ProductGallery_CascadeGrid extends ReyCore_WooCommerce_ProductGallery_Base
{
	 ...
	 * @return ReyCore_WooCommerce_ProductGallery_CascadeGrid
	 */
...
ReyCore_WooCommerce_ProductGallery_CascadeGrid::getInstance();
