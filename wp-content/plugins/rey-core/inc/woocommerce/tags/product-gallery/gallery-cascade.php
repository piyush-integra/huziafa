...
if( !class_exists('ReyCore_WooCommerce_ProductGallery_Cascade') ):
/**
 * This will initialize Rey's product page galleries
 */
class ReyCore_WooCommerce_ProductGallery_Cascade extends ReyCore_WooCommerce_ProductGallery_Base
{
	 ...
	 * @return ReyCore_WooCommerce_ProductGallery_Cascade
	 */
...
ReyCore_WooCommerce_ProductGallery_Cascade::getInstance();
